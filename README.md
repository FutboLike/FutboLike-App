...
- Reproductor Android nativo Media3 ExoPlayer para HLS `.m3u8` y enlaces directos compatibles.
...
Al ejecutar `node scripts/configure-android.mjs`, el proyecto añade automáticamente Media3 ExoPlayer, el módulo HLS y la interfaz nativa del reproductor. No necesitas editar Gradle manualmente.

El proyecto utiliza Media3 `1.8.0`, compatible con `compileSdk 35` y el Android Gradle Plugin incluido por Capacitor 7.
