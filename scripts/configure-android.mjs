...
// Elimina versiones anteriores para que el script sea seguro al ejecutarlo de nuevo.
appGradle = appGradle.replace(
  /^\s*implementation ['"]androidx\.media3:media3-(?:exoplayer|exoplayer-hls|ui):[^'"]+['"]\s*$/gm,
  ''
);
